...
public class SwordBlockingFeature implements ItemRenderingFeature<ItemRenderingFeatureExecutionContext>, ThirdPersonTransformer {
    ...
    public static final Lazy<SwordBlockingFeature> LAZY = new Lazy<>(SwordBlockingFeature::new);
    private static final Quaternion THIRD_PERSON_QUATERNION = new Quaternion(Vec3f.POSITIVE_Y, -45f, true);
    private static final Quaternion NEGATIVE_THIRD_PERSON_QUATERNION = new Quaternion(Vec3f.POSITIVE_Y, 45f, true);
    ...
    public void transform(ItemRenderingFeatureExecutionContext context) {
        ...
        matrices.multiply(Vec3f.POSITIVE_Y.getDegreesQuaternion(side * 13.365f));
        matrices.multiply(Vec3f.POSITIVE_Z.getDegreesQuaternion(side * 78.05f));
    }
